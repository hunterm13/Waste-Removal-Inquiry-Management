...
import LostReportGenerator from "../components/LostReportGenerator";
            ...
            <ProtectedRoute>
                <Container maxWidth='xl'>
                    <Container maxWidth="xl" style={{ display: "flex", justifyContent: "space-around" }}>
                        <LostReportGenerator startDate={startDate} endDate={endDate}/>
                    </Container>
                    ...
                    <Container maxWidth="lg">
                        <LostReportTable startDate={startDate} endDate={endDate}/>
                    </Container>
                </Container>
            </ProtectedRoute>
        );
